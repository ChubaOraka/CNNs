...
- [Lecture 10](https://www.meetup.com/MoCoMakers/events/mdxsppyxnblc/): For the last lecture of the year, we discussed another method of implementing object segmentation - U-Nets. This method is commonly used to analyze medical images. [The presentation](./Lecture%2010/CNN_Rockville_Session%208.pptx) of this lecture talks about U-Nets in 2-dimentional medical images - [retina images](https://github.com/orobix/retina-unet). They are also used in 3-dimensional medical images as gotten from [brain scans to detect tumors](https://pythonawesome.com/keras-3d-u-net-convolution-neural-network-designed-for-medical-image-segmentation/).